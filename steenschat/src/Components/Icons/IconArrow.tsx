  ...
  return (
    <div className={classes}>
      <svg width={arrowSize} height={arrowSize} viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path className={arrowClass} d="M22.5 9.375V35.625" stroke="#03009C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <path className={arrowClass} d="M35.625 22.5L22.5 35.625L9.375 22.5" stroke="#03009C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
